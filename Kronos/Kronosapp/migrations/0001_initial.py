# Generated by Django 5.1.1 on 2024-11-26 08:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('streetNumber', models.CharField(blank=True, max_length=10, validators=[Kronosapp.models.validate_numeric])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tssId', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Kronosapp.teachersubjectschool')),
            ],
        ),
        migrations.CreateModel(
            name='Year',
